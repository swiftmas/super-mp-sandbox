    ...
    if (path[5] == "inventory" && path[10] == "inventory"){
      if (db1[path[4]].name == db2[path[9]].name && db1[path[4]].name !== "-"){
       ...
       for (var item in globals.weaponData[db1[path[4]].name]) {
         if (["health", "mana", "corruption"].indexOf(item) > -1) {
           ...
           coredata["players"][interacter]["max" + item.charAt(0).toUpperCase() + item.slice(1)] -= globals.weaponData[db1[path[4]].name][item]
         }
       }
       var item1 = db1[path[4]].name
       var item2 = db2[path[9]].name
       ...
       for (var item in globals.weaponData[db1[path[9]].name]) {
         if (["health", "mana", "cor"].indexOf(item) > -1) {
           console.log("max" + item.charAt(0).toUpperCase() + item.slice(1), globals.weaponData[db1[path[9]].name][item])
           coredata["players"][interacter][item] += globals.weaponData[db1[path[9]].name][item]
           coredata["players"][interacter]["max" + item.charAt(0).toUpperCase() + item.slice(1)] += globals.weaponData[db1[path[9]].name][item]
         }
       }
       var item1 = db1[path[4]].name
       var item2 = db2[path[9]].name
