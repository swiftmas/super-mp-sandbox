    ...
    for (var npc in cdn) {
        if (cdn.hasOwnProperty(npc)) {
            ...
            if (cdn[npc].state == "000") {
                ...
                if(closetarget.length > 1 && closetarget[1] < 30 && closetarget[1] > 11 && globals.weaponData[cdn[npc].slot2].hasOwnProperty("projectile") && globals.weaponData[cdn[npc].slot2].projectile){
